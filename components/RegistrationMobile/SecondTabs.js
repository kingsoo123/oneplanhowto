    ...
    <div className="overflow-y-auto h-full w-full pt-4">
      <div className="w-[100%]">
        <div className="rgbaBG2 px-4 py-2 rounded-lg space-y-2">
          ...
          <p className="text-[#1E1E1E] font-normal text-base">
            Customer enters Planner Agent number
          </p>
        </div>
      </div>
      ...
      <div className="w-[100%]">
        <div className="rgbaBG2 px-4 py-2 rounded-lg space-y-2 mt-3">
          ...
          <p className="text-[#1E1E1E] font-normal text-base">
            If Agent is Licensed by One Plan, Customer is sent a One time Pin to
            share with the agent to they complete their registration
          </p>
        </div>
      </div>
